    ...
    <div className="container mx-auto px-6 py-12">
      ...
      <div className="glass-panel p-8 md:p-12 rounded-xl max-w-4xl mx-auto">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>
            For questions about this Privacy Policy, email: <a href="mailto:sayan@microsoftadmin.in" className="text-neon-dark dark:text-neon-green hover:underline">sayan@microsoftadmin.in</a>
          </p>
        </div>
      </div>
    </div>
